(function () {
  ...
  const WORLD_COLORS = {
    "sandar-qalasy": { solid: "var(--blue)", tint: "rgba(29,78,116,.10)" },
    "bolshekter-zertkhanasy": { solid: "var(--green)", tint: "rgba(31,109,70,.10)" },
    "pishinder-sheberkhanasy": { solid: "var(--sand-dark)", tint: "rgba(178,138,42,.14)" },
    "logika-ekspeditsiyasy": { solid: "var(--terracotta)", tint: "rgba(183,92,61,.12)" },
  };
